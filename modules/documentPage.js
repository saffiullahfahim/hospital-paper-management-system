					...
					<section class="custom-form-sec">
						<form class="icon-form" name="documentAddForm" action="" method="post">
							...
							<div class="mdl-input-bx">
								...
								<input type="file" spellcheck="false" name="" onchange="let docName = document.querySelector('#addDocumentName'); if(docName.value == ''){docName.value = this.files[0].name.slice(0, -4)}" id="addDocumentFile" class="form-control" autocomplete="off" required/>
							</div>
